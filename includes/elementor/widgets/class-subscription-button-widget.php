<?php
/**
 * Subscription Button Elementor Widget
 *
 ...
 */
class ZlaarkSubscriptionsSubscriptionButtonWidget extends ZlaarkSubscriptionsElementorWidget {
    
    /**
     * Get widget name
     */
    public function get_name() {
        return 'zlaark-subscription-button';
    }
    ...
    public function get_title() {
        return __('Subscription Button', 'zlaark-subscriptions');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => __('Subscribe Now', 'zlaark-subscriptions'),
        ...
        $this->add_control(
            'show_pricing',
            array(
                'label' => __('Show Pricing Info', 'zlaark-subscriptions'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'zlaark-subscriptions'),
                'label_off' => __('Hide', 'zlaark-subscriptions'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => __('Display pricing information above the button', 'zlaark-subscriptions'),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} .zlaark-subscription-btn',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => '#ffffff',
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn' => 'color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => '#28a745',
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn' => 'background-color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn:hover' => 'color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn:hover' => 'background-color: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'size_units' => array('px', '%'),
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'center',
                'selectors' => array(
                    '{{WRAPPER}} .zlaark-subscription-button-container' => 'text-align: {{VALUE}};',
                ),
                'condition' => array(
                    'button_width!' => 'full',
                ),
    ...
    protected function render() {
        ...
        $shortcode_atts = array(
            ...
            'class' => 'zlaark-subscription-btn elementor-subscription-btn'
        );
        ...
        ?>
        <div class="zlaark-widget-container zlaark-subscription-button-container">
            <?php if ($settings['show_pricing'] === 'yes'): ?>
                <div class="subscription-pricing-info">
                    <?php
                    if (class_exists('ZlaarkSubscriptionsShortcodes')) {
                        $shortcodes = ZlaarkSubscriptionsShortcodes::instance();
                        echo $shortcodes->subscription_pricing_shortcode(array(
                            'product_id' => $settings['product_id'],
                            'show_trial' => 'false',
                            'show_regular' => 'true',
                            'layout' => 'list'
            ...
            if (class_exists('ZlaarkSubscriptionsFrontend')) {
                ...
                echo $frontend->subscription_button_shortcode($shortcode_atts);
            } else {
